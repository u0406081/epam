...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<Human> mainList = getHumanList();
        List<Human> dublicatesList = getDuplicates(mainList);
...
*/
        /*
        User user = new User();
        user.setLastName("Вашетьков");
        user.setFirstName("Сергей");
        user.setMiddleName("Степанович");
        user.setRole(Roles.ADMIN);

        Тут так и не понял, что нужно сделать...
         */
